...
@EnableZuulProxy
public class Angular2UaaGatewayApp {

    private static final Logger log = LoggerFactory.getLogger(Angular2UaaGatewayApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes Angular2UaaGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Angular2UaaGatewayApp.class);
