...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Angular2UaaGateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Angular2UaaGateway API";

        private String description = "Angular2UaaGateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "Angular2UaaGateway";
